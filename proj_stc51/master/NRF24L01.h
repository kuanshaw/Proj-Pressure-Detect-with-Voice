...
#define TX_DATA_WITDH 5//发送数据宽度4个字节
#define RX_DATA_WITDH 5//接收数据宽度4个字节
/*******************命令寄存器***************************/
...
extern unchar RevTempDate0[5];//同道0接收数据
extern unchar RevTempDate1[5];//同道1接收数据

extern unchar overtime_counter_1, overtime_counter_2;
/*********************************************************/
#endif